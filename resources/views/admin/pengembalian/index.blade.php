    ...
    <div class="flex-1 overflow-y-auto p-8">
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between">
                <h3 class="font-bold text-slate-900 text-lg">Daftar Peminjaman</h3>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @if ($p->status === 'dikembalikan')
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-8 py-5 text-center">
                                    <span class="font-medium text-slate-900 text-sm">{{ $p->loanDetail->tool->deskripsi }}</span>
                                </td>
                                <td class="px-8 py-5 text-center">
                                    <span
                                        class="font-medium text-slate-900 text-sm">{{ $p->status }}</span>
                                </td>
                                <td class="px-8 py-5 text-center">
                                    <span
                                        class="font-medium text-slate-900 text-sm">{{ $p->tanggal_pinjam }}</span>
                                </td>
                                <td class="px-8 py-5 text-center">
                                    <span
