...
<form action="{{ route('admin.peminjam.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-5">
            ...
            <input type="text" name="name" id="title"
                ...
                value="{{ old('name') }}" placeholder="Masukan Nama Peminjam">
        ...
        <div class="mb-5">
            ...
            <input type="email" name="email" id="email"
                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 
                focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150"
                value="{{ old('email') }}" placeholder="Masukan Email Peminjam">
        ...
        <div class="mb-5">
            ...
            <input type="password" name="password" id="password"
                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 
                focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150"
                value="{{ old('password') }}" placeholder="Masukan Password Peminjam">
